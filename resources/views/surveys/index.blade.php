            ...
            <div class="mb-6 flex flex-wrap gap-4">
                <div class="flex flex-wrap gap-4 items-end">
                    ...
                    <button id="clear-btn" type="button"
                            class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 self-end h-[38px]">
                        Wissen
                    </button>
                </div>
            </div>
            ...
            <div id="surveys-container">
                <div class="space-y-4">
                    @forelse ($surveys as $survey)
                        <div
                            class="border rounded-lg p-6 {{ $survey->is_active ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200' }}">
                    ...
                    @empty
                        <div class="text-center py-12">
                            <p class="text-gray-500">Geen enquetes gevonden die aan je criteria voldoen.</p>
                        </div>
                    @endforelse
                </div>
        ...
        function fetchSurveys(page) {
            ...
            fetch(`{{ route('surveys.index') }}?${params}`, {
                ...
                .then(html => {
                    ...
                    // Koppel listeners voor pagineringslinks opnieuw
                    attachPaginationListeners();

                    // Werk de URL van de browser bij zonder herladen
